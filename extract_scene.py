...
def main(config):
    ...
    for SceneClass in scene_classes_to_render:
        do_final_stuff(SceneClass)

    # ThreadPoolExecutor(max_workers=len(scene_classes_to_render)).map(
    #     lambda SceneClass: do_final_stuff(SceneClass),
    #     scene_classes_to_render
    # )
    # for SceneClass in scene_classes_to_render:
        # try:
        #     # By invoking, this renders the full scene
    ...
    # for index, thread in enumerate(render_threads):
    #     thread.join()
