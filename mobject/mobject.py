...
class Mobject(Container):
    ...
    def set_x_to_be_same_as_that_of(self,mob,direction=ORIGIN):
        return self.set_x(mob.get_x(),direction=direction)

    def set_y_to_be_same_as_that_of(self,mob,direction=ORIGIN):
        return self.set_y(mob.get_y(),direction=direction)

    def set_z_to_be_same_as_that_of(self,mob,direction=ORIGIN):
        return self.set_z(mob.get_z(),direction=direction)
